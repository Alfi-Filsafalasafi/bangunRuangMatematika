 ...
 */
public class Kubus_Volume extends javax.swing.JFrame {

    /**
     * Creates new form Kubus_Volume
     */
    public Kubus_Volume() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Kubus.jpg"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            ...
            txt_hasil.setText(String.valueOf(df.format(k.volume())));
            txt_proses.setText("Volume = "+ k.getPanjang() + " x " + k.getPanjang() + " x " + k.getLebar() + " \n"
                              +"Volume = "+ k.luas() + " x " + k.getPanjang() + "\n"
                              +"Volume = "+ k.volume());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kubus_Volume.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
