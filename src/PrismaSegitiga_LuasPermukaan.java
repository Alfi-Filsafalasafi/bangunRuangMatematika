 ...
 */
public class PrismaSegitiga_LuasPermukaan extends javax.swing.JFrame {

    /**
     * Creates new form PrismaSegitiga_LuasPermukaan
     */
    public PrismaSegitiga_LuasPermukaan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txt_kel_alas = new javax.swing.JTextField();
        ...
        setTitle("Luas Permukaan Prisma Segitiga");
        setResizable(false);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LuasPermukaanPrismaSegitigaa.jpg"))); // NOI18N
        ...
        txt_luasAlas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_luasAlasActionPerformed(evt);
            }
        });

        txt_kel_alas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_kel_alasActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(6, 6, 6)
                            .addComponent(txt_kel_alas, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(11, 11, 11)
    ...
    private void txt_luasAlasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_luasAlasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_luasAlasActionPerformed

    private void txt_kel_alasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_kel_alasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_kel_alasActionPerformed
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            double luas = Double.parseDouble(txt_luasAlas.getText());
            double tinggi = Double.parseDouble(txt_tinggi.getText());
            double kel = Double.parseDouble(txt_kel_alas.getText());

            PrismaSegitiga prisma = new PrismaSegitiga();
            prisma.setLuasAlas(luas);
            prisma.setTinggiPrisma(tinggi);
            prisma.setKelAlas(kel);
            DecimalFormat df = new DecimalFormat("#.##");
            txt_hasil.setText(String.valueOf(df.format(prisma.luas_permukaan())));
            txt_proses.setText("Luas Permukaan =  2 x "+prisma.getLuasAlas()+"  +  ( "+prisma.getKelAlas()+ " x "+prisma.getTinggiPrisma()+ " ) \n"
                              +"Luas Permukaan =  "+ 2 * prisma.getLuasAlas()  +"  +  "+ prisma.getKelAlas() * prisma.getTinggiPrisma()+"\n"
                              +"Luas Permukaan =  "+prisma.luas_permukaan());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrismaSegitiga_LuasPermukaan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField txt_kel_alas;
