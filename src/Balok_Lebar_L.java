 ...
 */
public class Balok_Lebar_L extends javax.swing.JFrame {

    /**
     * Creates new form Balok_Lebar_L
     */
    public Balok_Lebar_L() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Lebar Balok di ketahui Luas Permukaan");
        setResizable(false);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LebarBalok_L.PNG"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            ...
            p_l = b.getPanjang() + b.getTinggi();
            bantu = (b.getLuasPermukaan() / 2)  -  b.getPanjang() * b.getTinggi();
            DecimalFormat df = new DecimalFormat("#.##");
            txt_hasil.setText(String.valueOf(df.format(b.lebar_l())));
            txt_proses.setText("Lebar = ( "+ b.getLuasPermukaan() + " / 2  - "+ b.getPanjang() + " x " + b.getTinggi() + " )  /  ( "+ b.getPanjang() + " + " + b.getTinggi() + " ) \n" 
                             + "Lebar = ( "+ b.getLuasPermukaan() / 2 + " - "+ b.getPanjang() * b.getTinggi() + " )  /  " + p_l +" \n"
                             + "Lebar = " + bantu + " / " + p_l +" \n"
                             + "Lebar = " + b.lebar_l());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Balok_Lebar_L.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
