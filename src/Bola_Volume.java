 ...
 */
public class Bola_Volume extends javax.swing.JFrame {

    /**
     * Creates new form Bola_Volume
     */
    public Bola_Volume() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Bola.jpg"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try {
            ...
            txt_hasil.setText(String.valueOf(df.format(bola.volume())));
            txt_proses.setText("Volume =  4/3 x 22/7 x "+ bola.getJarijari() + " x " + bola.getJarijari() + " x " + bola.getJarijari() + " \n"
                              +"Volume =  88/21 x "+ bola.getJarijari() * bola.getJarijari() *bola.getJarijari() + " \n" 
                              +"Volume =  " + 88 * bola.getJarijari() * bola.getJarijari() *bola.getJarijari() + " / 21  \n"
                              +"Volume =  "+ bola.volume());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bola_Volume.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
