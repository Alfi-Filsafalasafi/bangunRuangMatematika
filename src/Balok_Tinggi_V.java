 ...
 */
public class Balok_Tinggi_V extends javax.swing.JFrame {

    /**
     * Creates new form TinggiBalok
     */
    public Balok_Tinggi_V() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Tinggi Balok diketahui Volumenya");
        setResizable(false);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TinggiBalok.PNG"))); // NOI18N
    ...
    try  {
        ...
        txt_hasil.setText(String.valueOf(df.format(b.tinggi_v())));
        txt_proses.setText(" Tinggi = " + b.getVolume() + " / ( " + b.getPanjang() + " x " + b.getLebar() +" ) \n"
                          +" Tinggi = " + b.getVolume() + " / ( " + b.getPanjang() * b.getLebar() + " ) \n"
                          +" Tinggi = " + b.tinggi_v());
        }
    catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Balok_Tinggi_V.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
