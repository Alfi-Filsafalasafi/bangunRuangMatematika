 ...
 */
public class PrismaSegitiga_tinggi_V extends javax.swing.JFrame {

    /**
     * Creates new form PrismaSegitiga_tinggi_V
     */
    public PrismaSegitiga_tinggi_V() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TinggiPris_V.PNG"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            ...
            txt_hasil.setText(String.valueOf(df.format(prisma.tinggi_V())));
            txt_proses.setText("Tinggi  =  ( "+prisma.getVolume()+" / "+ prisma.getTinggiPrisma()+" )   /  ( 1/2 x "+prisma.getAlas()+" ) \n" 
                              +"Tinggi  =  "+prisma.getVolume() / prisma.getTinggiPrisma()+ "  /  "+ 0.5 * prisma.getAlas() + " \n"
                              +"Tinggi  =  "+prisma.tinggi_V());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrismaSegitiga_tinggi_V.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
