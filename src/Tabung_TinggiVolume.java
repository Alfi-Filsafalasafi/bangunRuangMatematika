 ...
 * @author Aurel
 */
public class Tabung_TinggiVolume extends javax.swing.JFrame {

    /**
     * Creates new form Tabung_TinggiVolume
     */
    public Tabung_TinggiVolume() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Tinggi Tabung dengan Volume");
        ...
        jLabel2.setText("Masukan Volume");
        ...
        setSize(new java.awt.Dimension(715, 320));
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            ...
            txt_hasil.setText(String.valueOf(b.tinggi_volume()));
            txt_proses.setText(" Tinggi = "+ b.getVolume() + " / " + b.getPhi() + " x " + b.getJarijari() + " x "+ b.getJarijari() +"\n"
                          +" Tinggi = " + b.getVolume() + " / " + b.getPhi() * b.getJarijari() * b.getJarijari()+ "\n"
                          +" Tinggi = " + b.tinggi_volume());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tabung_TinggiVolume.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tabung_TinggiVolume().setVisible(true);
            }
        });
    }
