 ...
 */
public class Bola_JariJari_V extends javax.swing.JFrame {

    /**
     * Creates new form BolaJariJari
     */
    public Bola_JariJari_V() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/BolaJari.jpg"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            ...
            txt_hasil.setText(String.valueOf(df.format(b.jari_jari_v())));
            txt_proses.setText("Jari - Jari =  ∛( 3 x "+ b.getVolume() + "  /  ( 4 x 22/7 ) )\n"
                              +"Jari - Jari = ∛( "+ b.getVolume() * 3 +"  /   88/7  )\n"
                              +"Jari - Jari = ∛( "+ df.format(b.getVolume() * 3 / 88 *7 ) + " ) \n"
                              +"Jari - Jari = "+ b.jari_jari_v());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bola_JariJari_V.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
