 ...
 */
public class Balok_Panjang_V extends javax.swing.JFrame {

    /**
     * Creates new form Balok_Panjang_V
     */
    public Balok_Panjang_V() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Panjang Balok diketahui Volume");
        setResizable(false);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/PanjangBalok_V.PNG"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            ...
            txt_hasil.setText(String.valueOf(df.format(b.panjang_v())));
            txt_proses.setText(" Panjang = " + b.getVolume() + " / ( " + b.getLebar() + " x " + b.getTinggi() +" ) \n"
                              +" Panjang = " + b.getVolume() + " / ( " + b.getLebar() * b.getTinggi() + " ) \n"
                              +" Panjang = " + b.panjang_v());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Balok_Panjang_V.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
