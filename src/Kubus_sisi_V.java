 ...
 */
public class Kubus_sisi_V extends javax.swing.JFrame {

    /**
     * Creates new form Kubus_sisi
     */
    public Kubus_sisi_V() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Sisi Kubus diketahui Volume");
        setResizable(false);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/sisiKubus_V.PNG"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            double sisi = Double.parseDouble(txt_volume.getText());

            Kubus k = new Kubus();
            k.setVolume(sisi);
            DecimalFormat df = new DecimalFormat("#.##");
            txt_hasil.setText(String.valueOf(df.format(k.sisi_V())));
            txt_proses.setText("sisi =  ∛ "+ k.getVolume() + "\n"
                              +"sisi = "+ k.sisi_V());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kubus_sisi_V.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
