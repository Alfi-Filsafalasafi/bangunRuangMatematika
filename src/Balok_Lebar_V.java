 ...
 */
public class Balok_Lebar_V extends javax.swing.JFrame {

    /**
     * Creates new form Balok_Lebar_V
     */
    public Balok_Lebar_V() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Lebar Balok Diketahui Volumenya");
        setResizable(false);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LebarBalok_V.PNG"))); // NOI18N
    ...
    private void btn_hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_hasilActionPerformed
        try  {
            ...
            txt_hasil.setText(String.valueOf(df.format(b.lebar_v())));
            txt_proses.setText(" Lebar = " + b.getVolume() + " / ( " + b.getPanjang() + " x " + b.getTinggi() +" ) \n"
                              +" Lebar = " + b.getVolume() + " / ( " + b.getPanjang() * b.getTinggi() + " ) \n"
                              +" Lebar = " + b.lebar_v());
        }
        catch(Exception xx){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Balok_Lebar_V.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
